...
class MainScreenAdapter : AsyncListDifferDelegationAdapter<ListNote>(DIFF_CALLBACK) {
    ...
    init {
        delegatesManager.addDelegate(NotebookScreenDelegates.notesVerticalDelegate)
    }
}